...
### Created by brianlamb ( brianlamb ) on 2020-11-21
script_version="0.0.1"  # if there is a VERSION.md in this script's folder, it will take priority for version number
readonly script_author="blamb.develop@blambstudio.com"
readonly script_creation="2020-11-21"
...
option|m|method|explain the 'method' option|def_method
param|1|zipfile|explain the 'zipfile' param
param|n|files|explain the 'files' multi
