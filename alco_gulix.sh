...
### Created by brianlamb ( brianlamb ) on 2021-03-01
...
readonly script_created="2021-03-01"
...
show_usage() {
  ...
  out "Description: This is my script - convert MTS to MP4 (transcode), transfer EXIF infor to new file"
